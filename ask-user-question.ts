...
export const DEFAULT_PROMPT_GUIDELINES: string[] = [
	`Use AskUserQuestion whenever the user's request is underspecified and you cannot proceed without concrete decisions — you can ask up to ${MAX_QUESTIONS} questions per invocation.`,
	...
	"Do not stack multiple AskUserQuestion calls back-to-back — group all clarifying questions into one invocation.",
];
